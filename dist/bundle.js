...
function weatherCard(data, unit) {
  var iconURL = "https://openweathermap.org/img/wn/".concat(data.weather[0].icon, "@2x.png");
...
/* harmony import */ var _js_components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/components */ "./src/js/components.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var apiKey = '6ee99052983aa34693798f1838f9a149';
